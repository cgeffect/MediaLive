...
- (IBAction)startCapture {
    ...
    _livePublisher = [[LivePublisher alloc] initWithRTMPURL:@"rtmp://192.168.2.176/live/livestream" videoWidth:config.width videoHeight:config.height videoFrameRate:config.fps videoBitRate:config.width * config.height * 4 audioSampleRate:44100 audioChannels:1 audioBitRate:6400 audioCodecName:@"libfdk_aac"];
